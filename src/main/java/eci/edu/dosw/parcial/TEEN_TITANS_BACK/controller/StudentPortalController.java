...
public class StudentPortalController {
    ...
    /**
     * Constructor del controlador de portal estudiantil.
     *
     * @param studentPortalService servicio que maneja la lógica del portal del estudiante
     */
    @Autowired
     ...
     * @return lista de grupos correspondientes al horario actual
     */
     ...
     *
     * @param studentId identificador del estudiante
     * @return DTO con información del progreso académico
     */
     ...
     * @return información de disponibilidad del grupo
     */
    ...
    /**
     * Obtiene las recomendaciones de cursos para el estudiante.
     *
     * @param studentId identificador del estudiante
    ...
    /**
     * Obtiene las fechas límite de inscripción del periodo académico actual.
     *
     * @return información del periodo académico con sus fechas límite
     */
     ...
     *
     * @param studentId identificador del estudiante
     * @return mapa con las alertas y su cantidad
     */
    ...
    /**
     * Obtiene la información de capacidad de un grupo.
     *
     * @param groupId identificador del grupo
     * @return información detallada de capacidad y ocupación
     */
    ...
    /**
     * Obtiene las estadísticas de inscripción por curso.
     *
     * @param courseCode código del curso
     * @return mapa con la cantidad de inscritos por grupo
     */
    ...
    /**
     * Convierte un objeto {@link StudentAcademicProgress} a un {@link StudentProgressDTO}.
     *
     * @param progress progreso académico del estudiante
     * @return DTO con la información estructurada
     */
    private StudentProgressDTO convertToProgressDTO(StudentAcademicProgress progress) {
        ...
        if (progress.getCoursesStatus() != null) {
            List<StudentProgressDTO.CourseProgressDTO> courseDTOs = progress.getCoursesStatus().stream()
                    .map(this::convertToCourseProgressDTO)
    ...
    /**
     * Convierte un {@link CourseStatusDetail} a un {@link StudentProgressDTO.CourseProgressDTO}.
     *
     * @param courseStatus detalle del estado del curso
     * @return DTO del curso
     */
    private StudentProgressDTO.CourseProgressDTO convertToCourseProgressDTO(CourseStatusDetail courseStatus) {
        StudentProgressDTO.CourseProgressDTO courseDTO = new StudentProgressDTO.CourseProgressDTO();
        Course course = courseStatus.getCourse();

        if (course != null) {
            courseDTO.setCourseId(course.getCourseCode());
            courseDTO.setCourseCode(course.getCourseCode());
            courseDTO.setCourseName(course.getName());
        }

        if (courseStatus.getStatus() != null) {
            courseDTO.setStatus(courseStatus.getStatus().name());
        }

        courseDTO.setGrade(courseStatus.getGrade());
        courseDTO.setSemester(courseStatus.getSemester());
        courseDTO.setCreditsEarned(courseStatus.getCreditsEarned());
        courseDTO.setApproved(courseStatus.isApproved());
        courseDTO.setComments(courseStatus.getComments());

        return courseDTO;
    }

    /**
     * Obtiene un resumen académico simplificado del estudiante.
     *
     * @param studentId identificador del estudiante
     * @return resumen académico con información general y métricas de progreso
     */
    ...
    /**
     * Verifica si un estudiante puede inscribirse en un curso específico.
     *
     * @param studentId identificador del estudiante
     * @param courseCode código del curso
     * @return mapa con la elegibilidad del estudiante para el curso
     */
    ...
    public ResponseEntity<?> checkEnrollmentEligibility(@PathVariable String studentId,
        ...
        try {
            ...
            boolean alreadyApproved = progress.getCoursesStatus().stream()
                    ...
                    .anyMatch(CourseStatusDetail::isApproved);
    ...
    /**
     * DTO para solicitud de disponibilidad de grupo.
     */
    ...
    /**
     * DTO para solicitud de inscripción en curso.
     */
