...
public class StudentAcademicProgressDTOTest {

    private StudentAcademicProgressDTO dto;
    ...
    void setUp() {
        ...
        dto = new StudentAcademicProgressDTO(
                "PROG001",
                "STU001",
                "Juan Pérez",
    ...
    void testConstructorPorDefecto_Borde() {
        StudentAcademicProgressDTO dtoVacio = new StudentAcademicProgressDTO();
    ...
    void testCamposCalculadosConValoresCero_Borde() {
        StudentAcademicProgressDTO dtoCero = new StudentAcademicProgressDTO(
                "PROG003",
                "STU003",
                "Carlos López",
                "Arquitectura",
    ...
    void testEqualsAndHashCode_Exitoso() {
        StudentAcademicProgressDTO dto1 = new StudentAcademicProgressDTO(
                "PROG001", "STU001", "Juan Pérez", "Ingeniería", "Facultad", "Pregrado",
                5, 10, 75, 160, 4.2, Arrays.asList(course1), 46.875, 85, 5
        );

        StudentAcademicProgressDTO dto2 = new StudentAcademicProgressDTO(
                "PROG001", "STU001", "Juan Pérez", "Ingeniería", "Facultad", "Pregrado",
                5, 10, 75, 160, 4.2, Arrays.asList(course1), 46.875, 85, 5
        );

        StudentAcademicProgressDTO dto3 = new StudentAcademicProgressDTO(
    ...
    void testEqualsCasosBorde_Borde() {
        ...
        assertNotEquals("No soy un StudentAcademicProgressDTO", dto1);
    }
    ...
    void testStudentAcademicProgressDTO_ValidacionCompleta_Compuesto() {
        assertAll("Validación completa de todas las propiedades",
                ...
                () -> assertTrue(dto.toString().contains("StudentAcademicProgressDTO"))
        );
    }
